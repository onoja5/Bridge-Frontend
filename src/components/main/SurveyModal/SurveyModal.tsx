  ...
  const phases = [
    {
      ...
      questions: [
        ...
        { id: 2, question: 'What is your email address?', type: 'text' },
        { id: 3, question: 'Select your age range', type: 'dropdown', options: ['15-18', '19-24', '25-30', '31+'] },
        { id: 4, question: 'What is your highest level of education?', type: 'dropdown', options: ['O-level', 'Diploma', 'Bachelor’s', 'Masters and above'] },
        { id: 5, question: 'What is your field of study or major?', type: 'text' },
      ],
    },
    {
      ...
      questions: [
        { id: 6, question: 'Which industries interest you the most?', type: 'multi-select', options: ['Tech', 'Finance', 'Healthcare', 'Marketing', 'Education'] },
        { id: 7, question: 'Which technical skills do you have?', type: 'multi-select', options: ['Programming', 'Data Analysis', 'Cloud Computing', 'UI/UX', 'Marketing'] },
        { id: 8, question: 'Which soft skills do you excel in?', type: 'multi-select', options: ['Leadership', 'Communication', 'Problem-Solving', 'Creativity'] },
        { id: 9, question: 'Do you have any work or internship experience?', type: 'text' },
      ],
    },
    {
      ...
      questions: [
        { id: 10, question: 'What type of work do you love doing?', type: 'text' },
        { id: 11, question: 'How do you prefer to learn?', type: 'multi-select', options: ['Online Courses', 'Hands-on Projects', 'Reading', 'Mentorship'] },
        { id: 12, question: 'What challenges do you face in achieving your career goals?', type: 'multi-select', options: ['No Access to Opportunities', 'Lack of Skills', 'No Mentorship'] },
