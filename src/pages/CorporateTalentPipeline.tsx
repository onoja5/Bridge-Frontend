        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center'>
            ...
            <p className='text-xl text-blue-100 max-w-3xl mx-auto mb-8'>
              Target Audience: Employers & corporate partners Overview: A
              structured recruitment & upskilling initiative connecting
              companies with job-ready talent trained through BridgeAI.
            </p>
          </div>
        </div>
      </div>
