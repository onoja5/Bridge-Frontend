        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center'>
            ...
            <p className='text-xl text-blue-100 max-w-3xl mx-auto mb-8'>
              Target Audience: Final-year students, early-career professionals &
              career switchers Overview: A 6–12 week immersive program designed
              to equip participants with AI-driven career roadmaps, real-world
              projects, and technical skills needed to thrive in the digital
              economy.
            </p>
          </div>
        </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='bg-white p-8 rounded-lg shadow-lg'>
              ...
              <p className='text-gray-600'>
                Learn in-demand digital skills such as coding, data analysis,
            ...
            <div className='bg-white p-8 rounded-lg shadow-lg'>
              ...
              <p className='text-gray-600'>
                Work on real-world projects to build a portfolio that showcases
                your skills.
              </p>
            </div>
            <div className='bg-white p-8 rounded-lg shadow-lg'>
              ...
              <p className='text-gray-600'>
                Receive guidance and support from experienced industry
                professionals.
              </p>
            </div>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
            <div>
              <div className='text-xl text-gray-600 space-y-4'>
                ...
                <p>
                  ✅ Hands-on training in AI, cloud computing, data analytics &
                  digital skills
                </p>
                <p>✅ Industry projects with real-world applications</p>
                <p>✅ Personalized mentorship from industry leaders</p>
                <p>
                  ✅ Resume reviews, mock interviews & job placement support
                </p>
