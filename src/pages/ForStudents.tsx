  ...
  const benefits = [
    {
      ...
      description:
        'Work on actual projects from leading companies and build your portfolio',
      icon: Briefcase,
    },
    {
  ...
  const testimonials = [
    {
      ...
      quote:
        'The hands-on experience I gained through BridgeAI projects has been invaluable for my career development.',
    },
    {
      name: 'Michael Lee',
      role: 'Business Major',
      ...
      quote:
        'Working on real projects helped me understand what employers are looking for and build my professional network.',
    },
  ];
    ...
    <div className='min-h-screen'>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center'>
            ...
            <p className='text-xl text-blue-100 max-w-3xl mx-auto mb-8'>
              Gain practical skills, build your portfolio, and connect with
              potential employers through hands-on projects and internships.
            </p>
      ...
      <div className='py-24 bg-white'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-lg text-gray-700 mb-8'>
            Our AI-driven platform empowers the workforce of tomorrow by
            bridging the gap between formal education and the evolving demands
            of the workplace. Students and graduates get AI-driven personalized
          ...
          <p className='text-lg text-gray-700'>
            Join us in redefining career development—one personalized blueprint
            at a time. Let’s build the bridge from education to employment.
          </p>
        </div>
      </div>
      ...
      <div className='bg-blue-900 py-24'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-xl text-blue-100 max-w-3xl mx-auto mb-8'>
            Join thousands of students who are gaining real-world experience
            through BridgeAI.
          </p>
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
            <Link
