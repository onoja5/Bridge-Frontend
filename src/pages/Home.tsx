...
export default function Home() {
  ...
  const partners = [
    {
      ...
      url: 'https://iypglobal.org/wp-content/uploads/2025/04/SEED-foundation.jpeg',
    }, // Updated logo
    {
      name: 'Microsoft',
      url: 'https://images.unsplash.com/photo-1633419461186-7d40a38105ec?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&h=80&q=80',
    },
    {
      name: 'AI Ignite',
      url: 'https://iypglobal.org/wp-content/uploads/2025/04/AI-Ignite.jpeg',
    },
    {
      name: 'Tech Valley',
      url: 'https://www.techvalley-me.com/images/front/final-logo.svg',
    },
    {
      name: 'Ayoks Digital',
      url: 'https://iypglobal.org/wp-content/uploads/2025/04/Ayoks-Digital.jpeg',
    },
  ];
  ...
  const programs = [
    {
      ...
      description:
        'Attract new employees and find existing talent ready for a new opportunity with AI-powered talent intelligence. Elevate top talent in the public sector',
      icon: Users,
    ...
    },
    {
      ...
      description:
        'From talent acquisition to management, our AI platform provides you a single view of talent across your entire workforce to inform every talent decision. Build your dream workforce',
      icon: BookOpen,
    ...
    },
    {
      ...
      description:
        'BridgeAI is a work-based learning platform connecting educators and employers to integrate real projects into course curriculum, leading to exciting and relevant resume-building experiences.',
      icon: Briefcase,
      link: '/project-internships',
      image:
        'https://images.pexels.com/photos/7794035/pexels-photo-7794035.jpeg',
    },
  ];
  ...
  const tabContent: Record<string, any> = {
    colleges: {
      ...
      description:
        'Find experiential learning projects to integrate into your curriculum, helping students gain real-world experience and improve employability outcomes.',
      image:
    ...
    businesses: {
      ...
      description:
        'Grow your business with access to a forward-thinking student talent pool to get your projects done - all at no cost to you. All while helping shape the future of work.',
      image:
    ...
    students: {
      ...
      description:
        'Gain employable skills and apply what you have learned by adding real value to organizations in a variety of industries. Put yourself on a fast track to a thriving career upon graduation.',
      image:
  ...
  return (
    <div className='min-h-screen'>
      ...
      <div
        ...
        style={{
          backgroundImage:
            'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.7)), url("https://images.unsplash.com/photo-1665686377065-08ba896d16fd?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80")',
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12'>
            ...
            <div className='text-center group'>
              ...
              <p className='text-gray-300 font-medium'>Users Impacted</p>
            </div>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-xl text-blue-100 max-w-3xl mx-auto'>
              An AI-driven platform that empowers the workforce of tomorrow by
              bridging the gap between formal education and the evolving demands
              of the workplace. Students/Graduates get AI-driven personalized
              career roadmaps, project-based learning, personalized skill
              development, and mentorship from seasoned professionals. For
              employers, the platform serves as a reliable pipeline for fresh,
              skilled, and job-ready talent, fostering a mutually beneficial
              ecosystem for professional and business growth.
            </p>
          </div>
          ...
          <div className='grid md:grid-cols-2 gap-12 items-center'>
            ...
            <div className='text-white'>
              ...
              <div className='space-y-4 mb-8'>
                {tabContent[activeTab].benefits.map(
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
            <div>
              ...
              <p className='text-lg mb-8'>
                Bridge AI enhances talent and business efficiency using
                AI-powered solutions. Discover how our platform can transform
                your organization.
              </p>
              <div className='space-y-4'>
                <div className='bg-gray-800 p-4 rounded-lg shadow-lg'>
                  <button
                    onClick={() =>
                      setActiveDropdown(
                        activeDropdown === 'insights' ? null : 'insights',
                      )
                    }
                    className='w-full flex items-center justify-between text-left'
                  >
                    <h3 className='text-lg font-semibold'>
                      Advanced AI-powered insights for better talent management
                    </h3>
                    <ChevronDown
                  ...
                  >
                    <p className='text-gray-300'>
                      Leverage AI-driven insights to make informed decisions
                      about talent acquisition, management, and development.
                    </p>
                  </div>
                </div>
                <div className='bg-gray-800 p-4 rounded-lg shadow-lg'>
                  <button
                    onClick={() =>
                      setActiveDropdown(
                        activeDropdown === 'automation' ? null : 'automation',
                      )
                    }
                    className='w-full flex items-center justify-between text-left'
                  >
                    <h3 className='text-lg font-semibold'>
                      Smart automation to streamline decision-making
                    </h3>
                    <ChevronDown
                      className={`w-6 h-6 transform transition-transform duration-300 ${
                  ...
                  >
                    <p className='text-gray-300'>
                      ...
                      with our smart automation tools.
                    </p>
                  </div>
                </div>
                <div className='bg-gray-800 p-4 rounded-lg shadow-lg'>
                  <button
                    onClick={() =>
                      setActiveDropdown(
                        activeDropdown === 'scalable' ? null : 'scalable',
                      )
                    }
                    className='w-full flex items-center justify-between text-left'
                  >
                  ...
                  <div
                    className={`mt-4 transition-all duration-300 ease-in-out ${
                      activeDropdown === 'scalable'
                        ? 'max-h-96 opacity-100'
                        : 'max-h-0 overflow-hidden opacity-0'
                    }`}
                  >
                    <p className='text-gray-300'>
                      Scale your business with confidence using our flexible and
      ...
      <div className='bg-blue-900 py-24'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-xl text-blue-100 max-w-3xl mx-auto mb-8'>
            Join leading companies who are already benefiting from BridgeAI's
            talent network.
          </p>
