      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-8">
            Target Audience: Aspiring professionals looking for hands-on experience
            Overview: A 3–6 month industry-aligned apprenticeship that allows participants to gain real-world experience while being mentored by experts.
          </p>
        </div>
      </div>
    </div>
