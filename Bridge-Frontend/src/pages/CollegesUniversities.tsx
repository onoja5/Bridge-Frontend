...
import { ArrowRight, BookOpen, Users, Target, Star, CheckCircle } from 'lucide-react';
import { Link } from 'react-router-dom';

export default function CollegesUniversities() {
  const benefits = [
    {
      title: "Enhanced Student Outcomes",
      description: "Improve graduate employability through real-world experience",
      icon: Target
    },
    {
      title: "Industry Partnerships",
      description: "Build valuable connections with leading organizations",
      icon: Users
    },
    {
      title: "Curriculum Innovation",
      description: "Integrate practical projects into your academic programs",
      icon: BookOpen
    }
  ];
  ...
  const testimonials = [
    ...
    },
    {
      ...
      quote: "The platform has helped us strengthen our industry partnerships and provide students with invaluable experience."
    }
  ];
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-8">
              Connect your students with real-world learning opportunities and strengthen 
              your industry partnerships.
            </p>
      ...
      <div className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-8">Comprehensive Platform Features</h2>
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  <CheckCircle className="h-6 w-6 text-green-500" />
                  <span className="text-gray-700">Industry partner network</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="h-6 w-6 text-green-500" />
      ...
      <div className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-16">What Our Partners Say</h2>
